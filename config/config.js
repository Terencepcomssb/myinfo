let APP_CONFIG = {
  'DEMO_APP_CLIENT_ID': 'STG-201511635R-PANPACIFIC-VEHICLELEASING',
  'DEMO_APP_CLIENT_SECRET': 'gzNLOvT8P52eTT8pf5civmnx8vyLSQET',
  'DEMO_APP_CLIENT_SECURE_CERT': './cert/panpacific_private.p12',
  'DEMO_APP_CLIENT_SECURE_CERT_PASSPHRASE': 'zsoft1234+-',
  'DEMO_APP_CALLBACK_URL': 'http://localhost:3001/callback',
  'DEMO_APP_PURPOSE': 'demonstrating MyInfo APIs',
  'DEMO_APP_SCOPES': 'uinfin,name,sex,dob,nationality,mobileno,email,regadd,drivinglicence.qdl.expirydate,drivinglicence.qdl.validity,drivinglicence.qdl.classes',
